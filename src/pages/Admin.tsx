                ...
                <div key={quest.id} className="rounded-2xl border border-amber-900/10 bg-white/60 p-4">
                  <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="text-[11px] font-black uppercase tracking-[0.18em] text-blue-950/55">
                        {stepLabel} · ID {quest.id} · {quest.chapter}
                      </div>
                      <h3 className="mt-1 text-xl font-black leading-tight text-slate-950">
                        {draft.title ?? quest.title}
                      </h3>
                      <div className="mt-1 text-xs font-black uppercase tracking-[0.14em] text-stone-500">
                        {questRole(quest)}
                      </div>
                    </div>
                  ...
                  <div className="mb-3 rounded-2xl border border-blue-950/10 bg-blue-950/5 px-3 py-2 text-xs font-black uppercase tracking-[0.12em] text-blue-950/60">
