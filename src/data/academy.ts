...
export interface AcademyQuest {
  ...
  chapter: string;
  kind: QuestKind;
  gameType?: 'spark-catcher' | 'library-sorter' | 'image-choice' | 'word-builder' | 'spell-order' | 'verb-assembler' | 'text-input';
  sortOrder?: number;
  taskLimit?: number;
  x: number;
  y: number;
...
export const questStories: Record<number, QuestStory> = {
  ...
  3: {
    arc: 'Kapitel I: Die verlorenen Wortfunken',
    mapTeaser: 'Im Wordbrew Workshop brodeln kurze Satzbausteine, Alltagswörter und Phrasen in kleinen Kesseln. Pip behauptet, einer rieche nach Frühstück.',
    missionIntro: 'Pip landet am Kesselrand. "Hier mischen wir Wörter, die man wirklich benutzen kann. Wenn ein Satzbaustein blubbert, ist das übrigens normal."',
    correct: 'Der Kessel blubbert blau statt grau. Pip grinst, weil der Satzbaustein genau eingerastet ist.',
    wrong: 'Ein paar Funken spritzen daneben. Pip wischt sich Ruß von der Nase: "Nicht schlimm. Manche Wörter brauchen einen zweiten Löffel."',
    completed: 'Der Sternenstempel fällt aus einer Rauchwolke und markiert deine Karte mit einem hellen Siegel.',
    rewardReveal: 'Der Sternenstempel macht nützliche Satzbausteine haltbarer.',
  },
  4: {
    arc: 'Kapitel I: Die verlorenen Wortfunken',
    mapTeaser: 'Auf den Sky Practice Yards sausen die Wortfunken durch die Luft, als hätten sie heimlich Flugunterricht genommen.',
    missionIntro: 'Pip zieht einen Kreis in die Luft. "Hier zählen wache Augen und schnelle Erinnerungen. Fang die Bewegungswörter, bevor sie davonziehen."',
  ...
  6: {
    arc: 'Kapitel I: Die verlorenen Wortfunken',
    mapTeaser: 'Im Glashaus wachsen Wortfunken wie störrische Samen. Pip behauptet, manche hätten ihn zuerst angeblinzelt.',
  ...
  7: {
    arc: 'Kapitel I: Die verlorenen Wortfunken',
    mapTeaser: 'Der Flüsterwald antwortet nur Kindern, die seine Wörter aufmerksam erkennen. Leider flüstert er manchmal auch sehr überzeugenden Unsinn.',
  ...
  8: {
    arc: 'Kapitel I: Die verlorenen Wortfunken',
    mapTeaser: 'In der Wyrm Cave bewacht ein alter Schatten besonders lange Wörter und Phrasen. Pip nennt ihn vorsichtig "ein sehr großes Vielleicht".',
  ...
  9: {
    arc: 'Kapitel I: Die verlorenen Wortfunken',
    mapTeaser: 'Am Moonwell Lake springt die Spur vom Workshop über das Wasser und sammelt Wörter, die noch ein bisschen Übung brauchen.',
  ...
  10: {
    arc: 'Kapitel I: Die verlorenen Wortfunken',
    mapTeaser: 'Auf den Spark Practice Grounds übt Pip mit dir, wie man Wortfunken ruhig einfängt, bevor die Karte ungeduldig wird.',
    missionIntro: 'Pip landet auf einem Übungskreis. "Keine Sorge. Das hier ist kein Finale. Das ist Aufwärmen mit dramatischem Staub."',
    correct: 'Ein Übungskreis leuchtet kurz auf. Pip tut so, als hätte er genau diese Flugbahn geplant.',
    wrong: 'Der Funke kullert davon. Pip räuspert sich: "Das war ein sehr sportlicher Fehler. Noch einmal."',
    completed: 'Der Funkenkompass dreht sich nach Norden und zeigt, dass die erste Übungsrunde sitzt.',
    rewardReveal: 'Der Funkenkompass hilft Pip, die nächsten verlorenen Wortfunken auf der Karte zu finden.',
  },
};
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        speaker: 'Pip',
        title: 'Vor dem Turm',
        body: 'Pip richtet seine Papierflügel. "Im Stargazer Tower müssen wir nicht kämpfen. Wir müssen Ordnung schaffen. Und vielleicht dem Nebel erklären, dass niemand alle Wörter an einem Dienstag schaffen muss."',
...
export const academyQuests: AcademyQuest[] = [
  ...
  {
    id: 10,
    title: 'Spark Practice Grounds',
    subtitle: 'Erste Übungsrunde für sichere Wortfunken',
    chapter: 'Übungshof',
    kind: 'mixed',
    sortOrder: 2,
    taskLimit: 10,
    ...
    sigil: 'spark',
    words: [],
    reward: 'Funkenkompass',
    guide: 'Auf dem Übungshof lernt Pip mit dir, wie Wortfunken ruhig bleiben, bevor der Pfad weiterleuchtet.',
  },
];
